...
public class Background {
	 ...
	 * @param cloud An integer representing the X position
	 * of the first cloud in the background (Recommended : 0).
	 */
	Background(int cloud) {
		this.firstCloud = cloud;
	}
	 ...
	 * @param day A boolean representing if the game is in day mode.
	 */
	 ...
	 * @param view A Graphics type object, this must be the same as the
	 * Graphics object used in all classes.
	 */
	...
	public void drawStar(int x, int y, Graphics view) {
		...
		// Stars
		int[] cordX = {x, x - 25, x + 15, x + 40, x + 40, x + 80,
				x + 40, x + 40, x + 15, x - 25};
		int[] cordY = {y, y - 35, y - 20, y - 50, y - 12, y, y + 12,
				y + 50, y + 20, y + 35};
		view.setColor(Color.YELLOW);
	...
	/**
	 * A method to allow clouds to loop back around once they have
	 * gone off-screen.
	 * @param l An integer representing the cloud's X position on screen.
	 * @param p An integer representing how many pixels the cloud is to
	 * move each loop.
	 ...
	 * @param view A Graphics type object, this must be the same as
	 * the Graphics object used in all classes.
	 * @param passed An integer representing how many objects the player
	 * has passed.
	 */
	 ...
	 * @param view A Graphics type object, this must be the same as
	 * the Graphics object used in all classes.
	 * @param lives An integer representing how many lives the player has
	 * left.
	 */
