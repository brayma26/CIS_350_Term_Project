...
public class Game extends JPanel implements MouseMotionListener, MouseListener {
	 ...
	 * @param g A Graphics type object, this must be the
	 * same as the Graphics object used in all classes.
	 */
	@Override
	public void paintComponent(Graphics g) {
		...
		if (screen == 2 && lives <= 0) {
			...
			if (screen == 3) {
				...
				g.setFont(new Font(
						"Comic Sans", Font.PLAIN, 20));
				g.drawString("Obstacles Passed: "
						+ obstaclesPassed() + " Lives: "
						+ lives, 1100, 50);
			...
			// pieces on the top layer are written last
		}
	}
	 ...
	 * @param o2 An ArrayList of Points that represent the other objects
	 * location.
