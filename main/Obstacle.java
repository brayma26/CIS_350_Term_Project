...
public class Obstacle {
	...
	/**  Represents the number of times the obstacle has been passed. */
	 ...
	 * @param x An integer representing the desired X position of the
	 * obstacle.
	 */
	 ...
	 * @param y An integer representing the desired Y position of the
	 * obstacle.
	 */
	...
	/**
	 * A method to obtain the internal count of obstacles the user has
	 * passed successfully.
	...
	/**
	 * A method to move the obstacle out of the player's range after
	 * a crash.
	 */
	public void move() {
	...
	/**
	 * A method to obtain the Array List of points that represent an
	 * obstacle.
	...
	/**
	 * A method to create a traffic cone and control the movement
	...
	public void drawTrafficCone(Graphics view) {
		...
		view.fillPolygon(new int[] {positionX, positionX + 25,
				positionX + 50}, new int[] {positionY,
						positionY - 50, positionY}, 3);
		view.fillRect(positionX - 5, positionY, 60, 10);
		view.setColor(Color.WHITE);
		view.fillPolygon(new int[] {positionX + 15,
				positionX + 25, positionX + 35},
				new int[] {positionY - 30, positionY
						- 50, positionY - 30}, 3);
	...
	/**
	 * A method to create a log and control the movement for
	...
	/**
	 * A method to allow obstacle to loop back around once they have
	 * gone off-screen.
	 * @param l An integer representing the obstacles X position on screen.
	 * @param p An integer representing how many pixels the obstacle is
	 * to move each loop.
