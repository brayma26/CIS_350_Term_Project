...
public class PowerUp {
	...
	/**
	 * A method to obtain the Array List of points that represent a
	 * PowerUp.
	...
	/**
	 * A method to create a flower and control the movement for this
	 * specific PowerUp.
	...
	/**
	 * A method to allow PowerUps to loop back around once they have gone
	 * off-screen.
	 * @param l An integer representing the PowerUp's X position on screen.
	 * @param p An integer representing how many pixels the PowerUp is to
	 * move each loop.
